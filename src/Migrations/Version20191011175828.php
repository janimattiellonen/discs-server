 ...
 */
final class Version20191011175828 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE disc (id INT AUTO_INCREMENT NOT NULL, price DOUBLE PRECISION NOT NULL, price_status VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, manufacturer VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, material VARCHAR(255) NOT NULL, speed SMALLINT NOT NULL, glide SMALLINT NOT NULL, stability SMALLINT NOT NULL, fade DOUBLE PRECISION NOT NULL, additional LONGTEXT NOT NULL, weight DOUBLE PRECISION NOT NULL, image VARCHAR(255) NOT NULL, is_missing TINYINT(1) NOT NULL, missing_description VARCHAR(255) NOT NULL, is_sold TINYINT(1) NOT NULL, sold_at DATE NOT NULL, sold_for DOUBLE PRECISION NOT NULL, is_broken TINYINT(1) NOT NULL, is_hole_in_one TINYINT(1) NOT NULL, hole_in_one_date DATE NOT NULL, hole_in_one_description VARCHAR(255) NOT NULL, is_collection_item TINYINT(1) NOT NULL, is_own_stamp TINYINT(1) NOT NULL, is_donated TINYINT(1) NOT NULL, donation_description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
